...
train["fsdp_size"] = 2
train["parallel"].update(dp_shard=2, cp=1)
# The established producer is fixed separately from later draft overrides.
train["offline_target_parallel"].update(dp_shard=2, cp=1)
